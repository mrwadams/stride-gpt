...
def analyze(
    ...
    worker_model: Annotated[str | None, typer.Option(help="Worker model — default tier, handles the bulk of calls (e.g. anthropic/claude-sonnet-5). A fast, low-cost model usually pays off here. Uses saved config if omitted.")] = None,
